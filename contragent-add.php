...
<div class="col-12 col-lg mt-4">
    ...
    <div class="col-12 col-lg mt-4 void">
        <div class="content-body h-100">
            <div class="content-block history-event">
                <h3 class="block-title">История событий</h3>
                <div class="histry-block">
                    <div class="d-flex align-items-center"><img src="/image/blue-check.svg" alt=""><span class="blue-text fw-bold">Редактирование адреса</span> <span>12.03.2024 9:30</span></div>
                    <div class="d-flex align-items-center"><span><strong>Менеджер:</strong> Инна 1С</span></div>
                    <div class="d-flex align-items-center"><span>Адрес изменен на “Place de l'Hôtel de Ville 74190 Bordo”</span></div>
                </div>
